    ...
    <div>
            ...
            <div className="text-center mt-10 h-[200px]">
                <form  onSubmit={handleSubmit} className="max-md:flex max-md:flex-col max-md:leading-[50px] w-[70%] m-auto" >
                    ...
                    <input type="password" name="password" id='password' ref={password} className=" m-auto mb-5 max-md:w-[90%] pl-3 bg-violet-200 text-white max-md:h-[40px] max-md:m-auto rounded-[5px] md:h-[50px] md:mt-5 w-[100%]" placeholder='**********' />
