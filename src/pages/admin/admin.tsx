...
export default function Admin() {
    return (
        <div className="w-[80%] m-auto flex space-x-5">
            ...
            <Link className="bg-blue-400 hover:bg-blue-200 p-2 pl-[100px] text-[30px] px-[100px] w-full m-auto rounded-[20px]" href={'/admin/adminUsers'}>Utilisateurs</Link>
            </div>
            </div>
            <div className="w-[50%] border-2 border-gray-400 mt-5 pb-5 rounded-[20px] text-center">
            ...
            <div className="mt-5 m-auto w-full text-center">
            <Link className="bg-blue-400 hover:bg-blue-200 p-2 pl-[100px] text-[30px]  px-[100px] w-full m-auto rounded-[20px]" href={'/admin/adminProducts'}>Produits</Link>
            </div>
            </div>
        </div>
    )
