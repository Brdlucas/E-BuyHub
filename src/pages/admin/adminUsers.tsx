...
function AdminUsers({ props }: any) {
  ...
  return (
    <div className="w-[90%] m-auto h-[928px]">
      <input className="mt-[15px] bg-blue-400 text-white hover:text-gray-700 hover:bg-blue-200 hover:cursor-pointer p-2 text-[20px] rounded-[20px]" onClick={handleDecroissent} type="button" value={"Décroissant"} />
