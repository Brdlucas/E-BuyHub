...
export default function AdminProducts() {
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = async e => {
    ...
    if (null !== name.current && description.current && price.current && category.current && stock.current) {
      product = { name: name.current.value, description: description.current.value, price: price.current.valueAsNumber, category: category.current.value, stock: stock.current.valueAsNumber }
    }
    ...
    router.push("/admin/products/adminProducts")
  }
  return (
